...
import { addProductToOrder, createOrder, getOrders } from '../../../redux/orderRedux';
import { useForm } from 'react-hook-form';
import { PRODUCT_MAX_ORDER, PRODUCT_MIN_ORDER } from '../../../config';
import styles from './SinglePageProduct.module.scss';
          ...
          <div className="col-12 col-lg-7 mt-3">
            ...
            <div className="row no-gutters col-12 justify-content-between align-items-end ">
              <div className="col-12 col-sm-4 mb-1">
                <img src={product?.images[1]?.url} className="img-fluid2" alt="product" />
              </div>
              <div className="col-12 col-sm-4 mb-1">
                <img src={product?.images[2]?.url} className="img-fluid2" alt="product" />
              </div>
              <div className="col-12 col-sm-4 mb-1">
                <img src={product?.images[3]?.url} className="img-fluid2" alt="product" />
              </div>
            </div>
          </div>
